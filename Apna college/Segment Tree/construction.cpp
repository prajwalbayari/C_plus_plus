...
//Segment trees are binary trees used to find sum of subarrays and update elements in O(log(n)) time
    ...
    while(ch!=5)
    {
        ...
        switch(ch)
        {
            ...
            case 2:int val,idx;
                    ...
                    cin>>idx>>val;
                    update(1,0,n-1,val-vec[idx],idx);
                    vec[idx]=val;
            ...
            case 3:int left,right;
                    ...
                    cin>>left>>right;
                    cout<<"Sum of the range is: "<<find(1,0,n-1,left,right)<<endl;
                    break;
